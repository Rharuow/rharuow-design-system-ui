...
const AccordionItem = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(AccordionPrimitive.Item, Object.assign({ ref: ref, className: cn(className) }, props)));
});
...
const AccordionTrigger = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(AccordionPrimitive.Header, { className: "flex" },
        React.createElement(AccordionPrimitive.Trigger, Object.assign({ ref: ref, className: cn("flex flex-1 items-center justify-between py-1 font-medium transition-all hover:underline [&[data-state=open]>svg]:rotate-180", className) }, props),
            children,
