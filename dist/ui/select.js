...
const SelectTrigger = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SelectPrimitive.Trigger, Object.assign({ ref: ref, className: cn("flex justify-between items-center h-10 w-full border z-10 border-input rounded-full text-white bg-transparent px-3 py-2 text-sm file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50", className) }, props),
        children,
...
const SelectLabel = React.forwardRef((_a, ref) => {
    ...
    return (React.createElement(SelectPrimitive.Label, Object.assign({ ref: ref, className: cn("text-white ", {
            "animate-label-focus": focused,
            "animate-label-blur": !focused,
        }, className), onFocus: (event) => {
