...
const Card = React.forwardRef((_a, ref) => {
    var { className, withGrab } = _a, props = __rest(_a, ["className", "withGrab"]);
    return (React.createElement("div", Object.assign({ ref: ref, className: cn("rounded-lg border bg-card text-card-foreground shadow-sm", { "hover:cursor-grab active:cursor-grabbing": withGrab }, className) }, props)));
});
